...
> **How to use this file:** Define who your customers are. AI tools use this to tailor language, focus on the right pain points, and avoid pitching to the wrong people. Build at least one primary persona — more if you serve meaningfully different segments.
...
When prompting AI, you can say: *"Write this for [Persona Name]"* and it will adjust accordingly.

---

## Persona 1 — [Name / Label]

> *Give this persona a name and a one-line summary. e.g. "The Overwhelmed Ops Manager"*

### Who they are
*Job title, seniority, company size/type, industry. Be specific.*

### Their situation
*What is happening in their world that makes them a potential customer? What does a typical day look like?*

### Their primary goal
*What are they trying to achieve — in work and in life?*

### Their pain points
*What frustrates them? What keeps them up at night? What have they already tried that hasn't worked?*

### What they need from us
*What specific problem do we solve for them? What would success look like?*

### How they talk
*What language do they use? What do they call their problems? Include phrases you've actually heard from real customers if possible.*

### What they're skeptical about
*What objections do they commonly raise? What would make them walk away?*

### Where we reach them
*What channels, communities, or content do they engage with?*

### How they make decisions
*Do they decide alone or with a committee? Is it a fast or slow process? What matters most — price, trust, features, proof?*

---

## Persona 2 — [Name / Label]

*(Duplicate the structure above)*

---

## Persona 3 — [Name / Label]

*(Duplicate the structure above — add more if needed)*

---

## Who We Are Not For

*Be explicit about customer types that are a bad fit. This prevents AI from writing content that attracts the wrong people or making promises you can't keep.*

- *e.g. Businesses looking for the cheapest option — we compete on quality, not price*
- *e.g. Solo freelancers — our product is built for teams of 5+*
- *e.g. [Industry] — we don't have the compliance infrastructure they need yet*

---

## Customer Lifecycle Stages

*How does someone move from stranger to loyal customer? Define the stages as they apply to your business.*

| Stage | What they know about us | What they need | How we communicate |
|-------|------------------------|----------------|-------------------|
| Unaware | Nothing | To discover us | *e.g. Educational content, no pitch* |
| Aware | We exist | To understand what we do | *e.g. Clear explainers, proof* |
| Considering | What we offer | To evaluate us vs. alternatives | *e.g. Case studies, demos, comparisons* |
| Customer | They've bought | To get value quickly | *e.g. Onboarding, support* |
| Loyal | Deep experience | To expand or advocate | *e.g. Upsell, referral, community* |

---

## Voice Adjustments by Persona

*Note any meaningful differences in how you communicate with different segments.*

| Persona | Tone shift | Language notes |
|---------|-----------|----------------|
| *[Persona 1]* | *e.g. More technical, peer-to-peer* | *Use industry-specific terms freely* |
| *[Persona 2]* | *e.g. More reassuring, outcome-focused* | *Avoid jargon, lead with business impact* |
| *[Persona 3]* | | |
...
*Paste actual quotes from customers — reviews, interviews, support chats. These are gold for AI-generated copy because they use real language your customers recognise.*

> *"[Quote]" — [Source: review / interview / etc.]*
